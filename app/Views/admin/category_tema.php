        ...
        <div class="col-lg-12">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-primary">
                  <h6 class="m-0 font-weight-bold text-light">Data Kategori Undangan Online</h6>
                </div>
...
<!-- Modal -->
        <form method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/add_categoryTema'); ?>">
...
<form method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/update_categoryTema'); ?>">
...
<script>
   ...
   $('#pilihHapus').on('click', function(event) {
        ...
        $.ajax({
            url : "<?= base_url('admin/delete_categoryTema') ?>",
            method : "POST",
            data : {id: id},
            async : true,
            dataType : 'html',
