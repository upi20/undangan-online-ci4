					...
					<div class="col-md-12">
						<div class="sw-invitation-home text-center">
							<div class="sw-content">
								<h2 class="typewrite" data-period="2000" data-type='[ "The Wedding", "<?php if($posisi_mempelai == 0) echo $nama_panggilan_pria." & ".$nama_panggilan_wanita; else echo $nama_panggilan_wanita." & ".$nama_panggilan_pria;?>", "Save Date" ]'></h2>
