    ...
    c.swipebox = function(e, f) {
        ...
        g = {
            ...
            build: function() {
                var a, b = this;
                c("body").append(s),
                o && j.settings.useSVG === !0 && (a = c("#swipebox-close").css("background-image"),
                a = a.replace("png", "svg"),
            ...
            gesture: function() {
                ...
                c("body").bind("touchstart", function(h) {
                    ...
                    i)
                        ...
                        j ? (j = !1,
                        b >= l && b >= e ? h.getPrev() : -l >= b && e >= b && h.getNext()) : q.hasClass("visible-bars") ? (h.clearTimeout(),
            ...
            openMedia: function(a) {
                ...
                void (f.isVideo(b) ? (e.html(f.getVideo(b)),
            ...
            getNext: function() {
                ...
                b.setSlide(d),
                b.preloadMedia(d + 1),
                j.settings.nextSlide && j.settings.nextSlide(d)) : j.settings.loopAtEnd === !0 ? (a = c("#swipebox-slider .slide").eq(d).contents().find("iframe").attr("src"),
                c("#swipebox-slider .slide").eq(d).contents().find("iframe").attr("src", a),
                d = 0,
                b.preloadMedia(d),
                b.setSlide(d),
